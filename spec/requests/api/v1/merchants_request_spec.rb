...
describe "Merchants API" do
  ...
  it "provides data for a single customer" do
    ...
    expect(data["data"]["attributes"]["created_at"]).to eq merchant.created_at.strftime('%Y-%m-%dT%I:%M:%S.%LZ')
    expect(data["data"]["attributes"]["updated_at"]).to eq merchant.updated_at.strftime('%Y-%m-%dT%I:%M:%S.%LZ')
  end
  ...
  describe "finds the first merchant" do
    ...
    it "by id" do
      ...
      expect(data["data"]["attributes"]["created_at"]).to eq @merchant_1.created_at.strftime('%Y-%m-%dT%I:%M:%S.%LZ')
      expect(data["data"]["attributes"]["updated_at"]).to eq @merchant_1.updated_at.strftime('%Y-%m-%dT%I:%M:%S.%LZ')
    end
    ...
    it "by name" do
      ...
      expect(data["data"]["attributes"]["created_at"]).to eq @merchant_2.created_at.strftime('%Y-%m-%dT%I:%M:%S.%LZ')
      expect(data["data"]["attributes"]["updated_at"]).to eq @merchant_2.updated_at.strftime('%Y-%m-%dT%I:%M:%S.%LZ')
    end
    ...
    xit "by created_at" do
      ...
      expect(data["data"]["attributes"]["created_at"]).to eq @merchant_3.created_at.strftime('%Y-%m-%dT%I:%M:%S.%LZ')
      expect(data["data"]["attributes"]["updated_at"]).to eq @merchant_3.updated_at.strftime('%Y-%m-%dT%I:%M:%S.%LZ')
    end
