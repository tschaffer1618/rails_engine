...
describe "Customers API" do
  ...
  it "provides data for a single customer" do
    ...
    expect(data["data"]["attributes"]["created_at"]).to eq customer.created_at.strftime('%Y-%m-%dT%I:%M:%S.%LZ')
  ...
  describe "finds the first customer" do
    ...
    it "by id" do
      ...
      expect(data["data"]["attributes"]["created_at"]).to eq @customer_1.created_at.strftime('%Y-%m-%dT%I:%M:%S.%LZ')
      expect(data["data"]["attributes"]["updated_at"]).to eq @customer_1.updated_at.strftime('%Y-%m-%dT%I:%M:%S.%LZ')
    end
    ...
    it "by first_name" do
      ...
      expect(data["data"]["attributes"]["created_at"]).to eq @customer_2.created_at.strftime('%Y-%m-%dT%I:%M:%S.%LZ')
      expect(data["data"]["attributes"]["updated_at"]).to eq @customer_2.updated_at.strftime('%Y-%m-%dT%I:%M:%S.%LZ')
    end
    ...
    it "by last_name" do
      ...
      expect(data["data"]["attributes"]["created_at"]).to eq @customer_3.created_at.strftime('%Y-%m-%dT%I:%M:%S.%LZ')
      expect(data["data"]["attributes"]["updated_at"]).to eq @customer_3.updated_at.strftime('%Y-%m-%dT%I:%M:%S.%LZ')
    end
